...
export const primeInput = `relative h-[46px] min-h-[46px] w-full rounded border border-gray-300 bg-[#f5f5f5] px-2 outline-none box-border focus:border-2 focus:border-[#1f456e] focus:bg-white`
